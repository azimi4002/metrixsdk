...
#pragma mark -
@implementation MXTimerCycle

+ (MXTimerCycle *)timerWithBlock:(dispatch_block_t)block
                            queue:(dispatch_queue_t)queue
                        startTime:(NSTimeInterval)startTime
                     intervalTime:(NSTimeInterval)intervalTime
                             name:(NSString*)name
{
    return [[MXTimerCycle alloc] initBlock:block queue:queue startTime:startTime intervalTime:intervalTime name:name];
}
...

{
    ...
    NSString * startTimeFormatted = [MXUtil secondsNumberFormat:startTime];
    NSString * intervalTimeFormatted = [MXUtil secondsNumberFormat:intervalTime];

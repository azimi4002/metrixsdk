...
@implementation MXActivityPackage
...
- (NSString *)description {
    return [NSString stringWithFormat:@"%@%@", [MXActivityKindUtil activityKindToString:self.activityKind], self.suffix];
}

- (NSString *)successMessage {
    return [NSString stringWithFormat:@"Tracked %@%@", [MXActivityKindUtil activityKindToString:self.activityKind], self.suffix];
}

- (NSString *)failureMessage {
    return [NSString stringWithFormat:@"Failed to track %@%@", [MXActivityKindUtil activityKindToString:self.activityKind], self.suffix];
}
...
//    self.callbackParameters = [decoder decodeObjectForKey:@"callbackParameters"];
    ...
    self.activityKind = [MXActivityKindUtil activityKindFromString:kindString];

    return self;
}

- (void)encodeWithCoder:(NSCoder *)encoder {
    NSString *kindString = [MXActivityKindUtil activityKindToString:self.activityKind];

...
preLaunchActionsArray:(NSArray*)preLaunchActionsArray
{
    ...
    if (selfI.metrixConfig.sendInBackground) {
        ...
        selfI.backgroundTimer = [MXTimerOnce timerWithBlock:^{ [selfI backgroundTimerFired]; }
                                                      queue:selfI.internalQueue
        ...
        selfI.metrixConfig.delayStart > 0)
    {
        ...
        selfI.delayStartTimer = [MXTimerOnce timerWithBlock:^{ [selfI sendFirstPackages]; }
                                                       queue:selfI.internalQueue
...
- (void)endI:(MXActivityHandler *)selfI {
    ...
    [selfI sessionStopI:selfI];
}

- (void)sessionStopI:(MXActivityHandler *)selfI{

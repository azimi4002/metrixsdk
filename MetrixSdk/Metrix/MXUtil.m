...
static NSString * const kClientSdk                  = @"ios0.1";
...
+ (NSMutableURLRequest *)requestForPostPackage:(NSString *)path
    ...
    if(parameters[@"app_id"]){
        [request setValue:parameters[@"app_id"] forHTTPHeaderField:@"X-Applicatioin-Id"];
    }
    if(parameters[@"app_info"] && parameters[@"app_info"][@"id"]){
        [request setValue:parameters[@"app_info"][@"id"] forHTTPHeaderField:@"X-Applicatioin-Id"];
    }

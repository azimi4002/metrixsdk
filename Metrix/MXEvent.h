...
/**
 * @brief Metrix event class.
 */
@interface MXEvent : NSObject<NSCopying>
 ...
 *                   at http://metrix.ir and should be six characters long.
 */
+ (nullable MXEvent *)eventWithEventToken:(nonnull NSString *)eventToken;
 ...
 *
 * @note In your dashboard at http://metrix.ir you can assign a callback URL to each
 ...
 *       For more information, visit: https://github.com/metrix/ios_purchase_sdk
 */
